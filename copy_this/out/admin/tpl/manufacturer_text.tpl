...
<form name="transfer" id="transfer" action="[{ $oViewConf->getSelfLink() }]" method="post">
    ...
    <input type="hidden" name="cl" value="manufacturer_text">
...
<form name="myedit" id="myedit" action="[{ $oViewConf->getSelfLink() }]" method="post" onSubmit="copyLongDesc( 'oxmanufacturers__oxlongdesc' );" style="padding: 0px;margin: 0px;height:0px;">
    [{ $oViewConf->getHiddenSid() }]
    <input type="hidden" name="cl" value="manufacturer_text">
    ...
    <input type="hidden" name="editval[oxmanufacturers__oxlongdesc]" value="">
    <table>
        <tr>
